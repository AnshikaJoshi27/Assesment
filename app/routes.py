...
This module defines functions for handling HTTP requests.
No decorators or blueprints - just plain functions that are registered
manually with the Flask app.
...
def setup_routes(app):
    """
    Setup all routes using simple Flask decorators.
